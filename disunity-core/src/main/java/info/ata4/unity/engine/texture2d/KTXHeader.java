...
public class KTXHeader implements Struct {
    ...
    public void write(DataWriter out) throws IOException {
        ...
        out.writeBytes(swap == ByteOrder.LITTLE_ENDIAN ? ENDIANESS_LE : ENDIANESS_BE);
        out.writeInt(glType);
